...
keymap.set("n", "e", "el" , {}) -- real use e for move to end word
keymap.set("n", "E", "eli" , {}) -- end word and modify
require("mason").setup()
...
local function get_python_path(workspace)
  ...
  return "python" -- exepath("python3") or exepath("python") or "python"
end
...
function my_send_to_server()
  ...
  dir_send["/home/nglazov/reps/wi-fi-stand/"] = "nglazov@192.168.104.19:/home/nglazov/reps/wi-fi-stand/"
